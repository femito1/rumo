...
def main() -> None:
    ...
    add("")
    add("Uma pista, se ajudar a lembrar: em janeiro o VR foi pago por **18 dias** e o VT da")
    add("pessoa do ADM cobriu só **14** — quatro dias de diferença. E `35,52 = 4 × 8,88`.")
    add("Pode ser um acerto de quatro dias, mas R$ 8,88 não é uma diária que apareça em")
    add("lugar nenhum, então é só hipótese.")
    add("")
    add("**O que ajudaria:** de onde vêm esses R$ 35,52? Se for de outra competência ou um")
    add("acerto pontual, passamos a tratá-lo da mesma forma.")
    add("")
